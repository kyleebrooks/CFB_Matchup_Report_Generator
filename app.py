...
def generate_report():
    ...
    prompt_intro = (
        ...
        f"Create a dedicated section for each of the following data groups: Matchup Overview (Provide an introduction to the matchup, with some context and history of the matchup to set the stage), SP Ratings, ELO Ratings, FPI Ratings, Advanced Team Stats, Returning Production, Team Talent, Team PPA, Player PPA, Team Season Stats, Adjusted Team Metrics, {home_full} injury updates, {away_full} injury updates, {home_full} roster Updates, {away_full} Roster Updates, {home_full} practice and Scrimmage updates, {away_full} practice and scrimmage updates, {home_full} vs {away_full} Media Matchup Analysis (This is a summary on the the matchup news articles provided), and Final Prediction. "
